...
var ErrOrderCantBeUpdated = errors.New("order can't be updated")
var ErrOrderCantBeDeleted = errors.New("order can't be deleted")
var ErrUserIsUsed = errors.New("user is used")
